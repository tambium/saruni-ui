...
import { ResetThemeProps, ResetThemeTokens, ThemeProp } from '../types';
...
export const ThemedReset = (props: ResetProps) => {
  const { children, ...rest } = props;
  const {
    tokens: { mode },
  } = useGlobalTheme({ mode: 'light' });
  const {
    tokens: { backgroundColor, fontSize },
  } = ResetTheme.useTheme({ mode, ...rest });
